```{r}
#Second model (father engagement model) for 619 project 
...
Model2Fit_2<-sem(Model2_2, data=semdataCtl5.IPV4, estimator="MLR", missing="fiml")
summary(Model2Fit_2, fit.measure=T, standardized=T, rsquare=T)
#residuals(Model2Fit_2, type='cor')
anova(Model1Fit_2, Model2Fit_2)
```
