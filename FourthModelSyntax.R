```{r}
#Fourth model (bidirectional model) for 619 project 
...
CopW3 ~ BlackOnly + HispanicCombo + OtherCombo + Work + BSF + HSDiploma + EduOther + MPF + IPVW2.d2 + IPVW2.m2 + CopW2 + CareW2.d + PlayW2.d
CareW3.d ~ BlackOnly + HispanicCombo + OtherCombo + Work + BSF + HSDiploma + EduOther + MPF + IPVW2.d2 + IPVW2.m2 + CareW2.d + CopW2 
PlayW3.d ~ BlackOnly + HispanicCombo + OtherCombo + Work + BSF + HSDiploma + EduOther + MPF + IPVW2.d2 + IPVW2.m2 + PlayW2.d + CopW2 
'

Model4Fit_2<-sem(Model4_2, data=semdataCtl5.IPV4, estimator="MLR", missing="fiml")
summary(Model4Fit_2, fit.measure=T, standardized=T, rsquare=T)
#residuals(Model4Fit_2, type='cor')
anova(Model3Fit_2, Model4Fit_2)
anova(Model1Fit_2, Model4Fit_2)
```
